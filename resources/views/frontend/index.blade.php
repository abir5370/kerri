                ...
                <div class="col-lg-12">
                    <div id="owl-demo" class="owl-carousel">
                        ...
                        <div class="text-center testi_boxes mx-auto">
                            ...
                            <div class="mt-2">
                                <div class="img_testi">
                                    <img src="{{asset($client->photo)}}" alt="" class="mx-auto img-thumbnail img-fluid d-block rounded-circle">
                                </div>
                                <p class="client_review fst-italic mt-4 text-center text-muted">"{{$client->review}}"</p>
                                <p class="client_name text-center mb-0 mt-4">- Ebony verty, <span class="fw-bold">{{$client->name}}</span></p>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="rounded bg-white p-2">
                        ...
                        <div class="content_blog p-3">
                            ...
                            <div class="mt-3">
                                ...
                                <p class="h6 mb-0"><a href="{{route('details.blog',$blog->id)}}" class="text-muted fw-bold">Read More...</a></p>
                            </div>
                        </div>
                    </div>
                </div>
